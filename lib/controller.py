...
class CreativesRebuildController:
    ...
    def checkForDupUID(self):
        ...
        for sub_item in list_of_submissions:
            ...
            if set_break:
                # skip submission
                logger.info(f"migrated label found - skip {submission_id} skip to next sub")
                continue
            ...
            # Spanish
            multi_select_options_34 = []
            multi_select_options_35 = []
            multi_select_options_36 = []
            multi_select_options_37 = []
            multi_select_options_38 = []
            multi_select_options_39 = []
            multi_select_options_40 = []
            multi_select_options_41 = []
            multi_select_options_42 = []
            multi_select_options_43 = []
            multi_select_options_44 = []
            multi_select_options_45 = []
            multi_select_options_46 = []
            multi_select_options_47 = []
            multi_select_options_48 = []
            multi_select_options_49 = []
            multi_select_options_50 = []
            multi_select_options_51 = []
            multi_select_options_52 = []
            multi_select_options_53 = []
            multi_select_options_54 = []
            multi_select_options_55 = []
            multi_select_options_56 = []
            multi_select_options_57 = []
            multi_select_options_58 = []
            multi_select_options_59 = []
            multi_select_options_60 = []
            multi_select_options_61 = []
            multi_select_options_62 = []
            multi_select_options_63 = []
            multi_select_options_64 = []
            multi_select_options_65 = []
            multi_select_options_66 = []
            ...
            if project_id == self.project_id_1 or project_id == self.project_id_3:
                ...
                for response in response_list:
                    ...
                    # Pull the initial form response data
                    ...
                    for data in field_data:
                        ...
                        # check if its an Artist or Organization (brnching)
                        if field_id == config.org_or_artist_field_id:
                            ...
                            if artist_or_org == config.spanish_org_or_artist_field_option_2:
                                logger.info(f"orginization submission {submission_id}")
                        if field_id == config.spanish_org_or_artist_field_id:
                            artist_or_org = data.getFieldValue("SINGLE_RESPONSE")
                            if artist_or_org == config.spanish_org_or_artist_field_option_2:
                                logger.info(f"spanish orginization submission {submission_id}")
                        ...
                        # AEP Organization branch option
                        if field_id == config.org_reference_form_field_id:
                            for resp in reference_responses:
                                ...
                                if resp.getFormFieldId() == config.org_reference_form_field_id and ref_email == resp.getRefEmail():
                                    if date_1 is None or date_1 < resp.getCreatedAt():
                                        ...
                                        primary_unique_id = primary_unique_id.replace("-", "")
                                        logger.info(f"orginiization required artist primary UID: {primary_unique_id}")

                        # Spanish
                        if field_id == config.spanish_artist_collab_reference_form_id:
                            for resp in reference_responses:
                                logger.info(f"spanish ref response refEmail 1: {resp.getRefEmail()}, ref_email: {ref_email}")
                                if resp.getFormFieldId() == config.spanish_artist_collab_reference_form_id and ref_email == resp.getRefEmail():
                                    if date_1 is None or date_1 < resp.getCreatedAt():
                                        date_1 = resp.getCreatedAt()
                                        ref_field_data = resp.getFieldData()
                                        for ref_data in ref_field_data:
                                            logger.info(f"spanish ref form data 1: {ref_data}")
                                            item_id = ref_data.getFormFieldId()
                                        ...
                                        primary_unique_id = primary_unique_id.replace(" ", "")
                                        primary_unique_id = primary_unique_id.replace("-", "")
                                        logger.info(f"spanish orginization primary UID: {primary_unique_id}")
                        ...
                        # Spanish (project-1) Reference from UIDs
                        ...
                        # Spanish - map multi-select fields to internal form single select fields
                        #
                        # Spanish - ineligible multi-selects
                        elif field_id == config.spanish_ineligible_survey_multi_select_id_1:
                            multi_select_options_34 = data.getOptions()
                            for option in multi_select_options_34:
                                if option == config.ineligible_survey_multi_options_ids_1[0]:
                                    single_select_options_1.append(config.ineligible_single_select_option_id_1)
                                elif option == config.ineligible_survey_multi_options_ids_1[1]:
                                    single_select_options_2.append(config.ineligible_single_select_option_id_2)
                        ...
                        elif field_id == config.spanish_ineligible_survey_multi_select_id_2:
                            multi_select_options_35 = data.getOptions()
                            for option in multi_select_options_35:
                                if option == config.spanish_ineligible_survey_multi_options_ids_2[0]:
                                    single_select_options_7.append(config.ineligible_single_select_option_id_7)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_2[1]:
                                    single_select_options_8.append(config.ineligible_single_select_option_id_8)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_2[2]:
                                    single_select_options_9.append(config.ineligible_single_select_option_id_9)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_2[3]:
                                    single_select_options_10.append(config.ineligible_single_select_option_id_10)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_2[4]:
                                    single_select_options_11.append(config.ineligible_single_select_option_id_11)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_2[5]:
                                    single_select_options_12.append(config.ineligible_single_select_option_id_12)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_2[6]:
                                    single_select_options_13.append(config.ineligible_single_select_option_id_13)

                        elif field_id == config.spanish_ineligible_survey_multi_select_id_3:
                            multi_select_options_36 = data.getOptions()
                            for option in multi_select_options_36:
                                if option == config.spanish_ineligible_survey_multi_options_ids_3[0]:
                                    single_select_options_14.append(config.ineligible_single_select_option_id_14)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_3[1]:
                                    single_select_options_15.append(config.ineligible_single_select_option_id_15)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_3[2]:
                                    single_select_options_16.append(config.ineligible_single_select_option_id_16)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_3[3]:
                                    single_select_options_17.append(config.ineligible_single_select_option_id_17)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_3[4]:
                                    single_select_options_18.append(config.ineligible_single_select_option_id_18)

                        elif field_id == config.spanish_ineligible_survey_multi_select_id_4:
                            multi_select_options_37 = data.getOptions()
                            for option in multi_select_options_37:
                                if option == config.spanish_ineligible_survey_multi_options_ids_4[0]:
                                    single_select_options_19.append(config.ineligible_single_select_option_id_19)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_4[1]:
                                    single_select_options_20.append(config.ineligible_single_select_option_id_20)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_4[2]:
                                    single_select_options_21.append(config.ineligible_single_select_option_id_21)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_4[3]:
                                    single_select_options_22.append(config.ineligible_single_select_option_id_22)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_4[4]:
                                    single_select_options_23.append(config.ineligible_single_select_option_id_23)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_4[5]:
                                    single_select_options_24.append(config.ineligible_single_select_option_id_24)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_4[6]:
                                    single_select_options_25.append(config.ineligible_single_select_option_id_25)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_4[7]:
                                    single_select_options_26.append(config.ineligible_single_select_option_id_26)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_4[8]:
                                    single_select_options_27.append(config.ineligible_single_select_option_id_27)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_4[9]:
                                    single_select_options_28.append(config.ineligible_single_select_option_id_28)

                        elif field_id == config.spanish_ineligible_survey_multi_select_id_5:
                            multi_select_options_38 = data.getOptions()
                            for option in multi_select_options_38:
                                if option == config.spanish_ineligible_survey_multi_options_ids_5[0]:
                                    single_select_options_29.append(config.ineligible_single_select_option_id_29)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_5[1]:
                                    single_select_options_30.append(config.ineligible_single_select_option_id_30)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_5[2]:
                                    single_select_options_31.append(config.ineligible_single_select_option_id_31)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_5[3]:
                                    single_select_options_32.append(config.ineligible_single_select_option_id_32)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_5[4]:
                                    single_select_options_33.append(config.ineligible_single_select_option_id_33)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_5[5]:
                                    single_select_options_34.append(config.ineligible_single_select_option_id_34)

                        elif field_id == config.spanish_ineligible_survey_multi_select_id_6:
                            multi_select_options_39 = data.getOptions()
                            for option in multi_select_options_39:
                                if option == config.spanish_ineligible_survey_multi_options_ids_6[0]:
                                    single_select_options_35.append(config.ineligible_single_select_option_id_35)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_6[1]:
                                    single_select_options_36.append(config.ineligible_single_select_option_id_36)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_6[2]:
                                    single_select_options_37.append(config.ineligible_single_select_option_id_37)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_6[3]:
                                    single_select_options_38.append(config.ineligible_single_select_option_id_38)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_6[4]:
                                    single_select_options_39.append(config.ineligible_single_select_option_id_39)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_6[5]:
                                    single_select_options_40.append(config.ineligible_single_select_option_id_40)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_6[6]:
                                    single_select_options_41.append(config.ineligible_single_select_option_id_41)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_6[7]:
                                    single_select_options_42.append(config.ineligible_single_select_option_id_42)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_6[8]:
                                    single_select_options_43.append(config.ineligible_single_select_option_id_43)

                        elif field_id == config.spanish_ineligible_survey_multi_select_id_7:
                            multi_select_options_40 = data.getOptions()
                            for option in multi_select_options_40:
                                if option == config.spanish_ineligible_survey_multi_options_ids_7[0]:
                                    single_select_options_44.append(config.ineligible_single_select_option_id_44)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[1]:
                                    single_select_options_45.append(config.ineligible_single_select_option_id_45)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[2]:
                                    single_select_options_46.append(config.ineligible_single_select_option_id_46)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[3]:
                                    single_select_options_47.append(config.ineligible_single_select_option_id_47)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[4]:
                                    single_select_options_48.append(config.ineligible_single_select_option_id_48)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[5]:
                                    single_select_options_49.append(config.ineligible_single_select_option_id_49)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[6]:
                                    single_select_options_50.append(config.ineligible_single_select_option_id_50)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[7]:
                                    single_select_options_51.append(config.ineligible_single_select_option_id_51)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[8]:
                                    single_select_options_52.append(config.ineligible_single_select_option_id_52)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[9]:
                                    single_select_options_53.append(config.ineligible_single_select_option_id_53)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[10]:
                                    single_select_options_54.append(config.ineligible_single_select_option_id_54)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[11]:
                                    single_select_options_55.append(config.ineligible_single_select_option_id_55)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[12]:
                                    single_select_options_56.append(config.ineligible_single_select_option_id_56)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_7[13]:
                                    single_select_options_57.append(config.ineligible_single_select_option_id_57)

                        elif field_id == config.spanish_ineligible_survey_multi_select_id_8:
                            multi_select_options_41 = data.getOptions()
                            for option in multi_select_options_41:
                                if option == config.spanish_ineligible_survey_multi_options_ids_8[0]:
                                    single_select_options_58.append(config.ineligible_single_select_option_id_58)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[1]:
                                    single_select_options_59.append(config.ineligible_single_select_option_id_59)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[2]:
                                    single_select_options_60.append(config.ineligible_single_select_option_id_60)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[3]:
                                    single_select_options_61.append(config.ineligible_single_select_option_id_61)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[4]:
                                    single_select_options_62.append(config.ineligible_single_select_option_id_62)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[5]:
                                    single_select_options_63.append(config.ineligible_single_select_option_id_63)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[6]:
                                    single_select_options_64.append(config.ineligible_single_select_option_id_64)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[7]:
                                    single_select_options_65.append(config.ineligible_single_select_option_id_65)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[8]:
                                    single_select_options_66.append(config.ineligible_single_select_option_id_66)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[9]:
                                    single_select_options_67.append(config.ineligible_single_select_option_id_67)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[10]:
                                    single_select_options_68.append(config.ineligible_single_select_option_id_68)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[11]:
                                    single_select_options_69.append(config.ineligible_single_select_option_id_69)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_8[12]:
                                    single_select_options_70.append(config.ineligible_single_select_option_id_70)

                        elif field_id == config.spanish_ineligible_survey_multi_select_id_9:
                            multi_select_options_42 = data.getOptions()
                            for option in multi_select_options_42:
                                if option == config.spanish_ineligible_survey_multi_options_ids_9[0]:
                                    single_select_options_71.append(config.ineligible_single_select_option_id_71)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_9[1]:
                                    single_select_options_72.append(config.ineligible_single_select_option_id_72)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_9[2]:
                                    single_select_options_73.append(config.ineligible_single_select_option_id_73)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_9[3]:
                                    single_select_options_74.append(config.ineligible_single_select_option_id_74)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_9[4]:
                                    single_select_options_75.append(config.ineligible_single_select_option_id_75)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_9[5]:
                                    single_select_options_76.append(config.ineligible_single_select_option_id_76)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_9[6]:
                                    single_select_options_77.append(config.ineligible_single_select_option_id_77)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_9[7]:
                                    single_select_options_78.append(config.ineligible_single_select_option_id_78)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_9[8]:
                                    single_select_options_79.append(config.ineligible_single_select_option_id_79)

                        elif field_id == config.spanish_ineligible_survey_multi_select_id_10:
                            multi_select_options_43 = data.getOptions()
                            for option in multi_select_options_43:
                                if option == config.spanish_ineligible_survey_multi_options_ids_10[0]:
                                    single_select_options_80.append(config.ineligible_single_select_option_id_80)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_10[1]:
                                    single_select_options_81.append(config.ineligible_single_select_option_id_81)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_10[2]:
                                    single_select_options_82.append(config.ineligible_single_select_option_id_82)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_10[3]:
                                    single_select_options_83.append(config.ineligible_single_select_option_id_83)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_10[4]:
                                    single_select_options_84.append(config.ineligible_single_select_option_id_84)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_10[5]:
                                    single_select_options_85.append(config.ineligible_single_select_option_id_85)

                        elif field_id == config.spanish_ineligible_survey_multi_select_id_11:
                            multi_select_options_44 = data.getOptions()
                            for option in multi_select_options_44:
                                if option == config.spanish_ineligible_survey_multi_options_ids_11[0]:
                                    single_select_options_86.append(config.ineligible_single_select_option_id_86)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_11[1]:
                                    single_select_options_87.append(config.ineligible_single_select_option_id_87)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_11[2]:
                                    single_select_options_88.append(config.ineligible_single_select_option_id_88)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_11[3]:
                                    single_select_options_89.append(config.ineligible_single_select_option_id_89)
                                elif option == config.spanish_ineligible_survey_multi_options_ids_11[4]:
                                    single_select_options_90.append(config.ineligible_single_select_option_id_90)

                        # Spanish - AEP multi-select
                        elif field_id == config.spanish_aep_multi_select_id_1:
                            multi_select_options_45 = data.getOptions()
                            for option in multi_select_options_45:
                                if option == config.spanish_aep_multi_options_ids_1[0]:
                                    single_select_options_91.append(config.aep_single_select_option_id_1)
                                elif option == config.spanish_aep_multi_options_ids_1[1]:
                                    single_select_options_92.append(config.aep_single_select_option_id_2)
                                elif option == config.spanish_aep_multi_options_ids_1[2]:
                                    single_select_options_93.append(config.aep_single_select_option_id_3)
                                elif option == config.spanish_aep_multi_options_ids_1[3]:
                                    single_select_options_94.append(config.aep_single_select_option_id_4)
                                elif option == config.spanish_aep_multi_options_ids_1[4]:
                                    single_select_options_95.append(config.aep_single_select_option_id_5)
                                elif option == config.spanish_aep_multi_options_ids_1[5]:
                                    single_select_options_96.append(config.aep_single_select_option_id_6)
                                elif option == config.spanish_aep_multi_options_ids_1[6]:
                                    single_select_options_97.append(config.aep_single_select_option_id_7)
                                elif option == config.spanish_aep_multi_options_ids_1[7]:
                                    single_select_options_98.append(config.aep_single_select_option_id_8)
                                elif option == config.spanish_aep_multi_options_ids_1[8]:
                                    single_select_options_99.append(config.aep_single_select_option_id_9)

                        elif field_id == config.spanish_aep_multi_select_id_2:
                            multi_select_options_46 = data.getOptions()
                            for option in multi_select_options_46:
                                if option == config.spanish_aep_multi_options_ids_2[0]:
                                    single_select_options_100.append(config.aep_single_select_option_id_10)
                                elif option == config.spanish_aep_multi_options_ids_2[1]:
                                    single_select_options_101.append(config.aep_single_select_option_id_11)
                                elif option == config.spanish_aep_multi_options_ids_2[2]:
                                    single_select_options_102.append(config.aep_single_select_option_id_12)
                                elif option == config.spanish_aep_multi_options_ids_2[3]:
                                    single_select_options_103.append(config.aep_single_select_option_id_13)
                                elif option == config.spanish_aep_multi_options_ids_2[4]:
                                    single_select_options_104.append(config.aep_single_select_option_id_14)
                                elif option == config.spanish_aep_multi_options_ids_2[5]:
                                    single_select_options_105.append(config.aep_single_select_option_id_15)

                        elif field_id == config.spanish_aep_multi_select_id_3:
                            multi_select_options_47 = data.getOptions()
                            for option in multi_select_options_47:
                                if option == config.spanish_aep_multi_options_ids_3[0]:
                                    single_select_options_106.append(config.aep_single_select_option_id_16)
                                elif option == config.spanish_aep_multi_options_ids_3[1]:
                                    single_select_options_107.append(config.aep_single_select_option_id_17)
                                elif option == config.spanish_aep_multi_options_ids_3[2]:
                                    single_select_options_108.append(config.aep_single_select_option_id_18)
                                elif option == config.spanish_aep_multi_options_ids_3[3]:
                                    single_select_options_109.append(config.aep_single_select_option_id_19)
                                elif option == config.spanish_aep_multi_options_ids_3[4]:
                                    single_select_options_110.append(config.aep_single_select_option_id_20)

                        elif field_id == config.spanish_aep_multi_select_id_4:
                            multi_select_options_48 = data.getOptions()
                            for option in multi_select_options_48:
                                if option == config.spanish_aep_multi_options_ids_4[0]:
                                    single_select_options_111.append(config.aep_single_select_option_id_21)
                                elif option == config.spanish_aep_multi_options_ids_4[1]:
                                    single_select_options_112.append(config.aep_single_select_option_id_22)
                                elif option == config.spanish_aep_multi_options_ids_4[2]:
                                    single_select_options_113.append(config.aep_single_select_option_id_23)
                                elif option == config.spanish_aep_multi_options_ids_4[3]:
                                    single_select_options_114.append(config.aep_single_select_option_id_24)
                                elif option == config.spanish_aep_multi_options_ids_4[4]:
                                    single_select_options_115.append(config.aep_single_select_option_id_25)

                        elif field_id == config.spanish_aep_multi_select_id_5:
                            multi_select_options_49 = data.getOptions()
                            for option in multi_select_options_49:
                                if option == config.spanish_aep_multi_options_ids_5[0]:
                                    single_select_options_116.append(config.aep_single_select_option_id_26)
                                elif option == config.spanish_aep_multi_options_ids_5[1]:
                                    single_select_options_117.append(config.aep_single_select_option_id_27)
                                elif option == config.spanish_aep_multi_options_ids_5[2]:
                                    single_select_options_118.append(config.aep_single_select_option_id_28)
                                elif option == config.spanish_aep_multi_options_ids_5[3]:
                                    single_select_options_119.append(config.aep_single_select_option_id_29)
                                elif option == config.spanish_aep_multi_options_ids_5[4]:
                                    single_select_options_120.append(config.aep_single_select_option_id_30)
                                elif option == config.spanish_aep_multi_options_ids_5[5]:
                                    single_select_options_121.append(config.aep_single_select_option_id_31)

                        elif field_id == config.spanish_aep_multi_select_id_6:
                            multi_select_options_50 = data.getOptions()
                            for option in multi_select_options_50:
                                if option == config.spanish_aep_multi_options_ids_6[0]:
                                    single_select_options_122.append(config.aep_single_select_option_id_32)
                                elif option == config.spanish_aep_multi_options_ids_6[1]:
                                    single_select_options_123.append(config.aep_single_select_option_id_33)
                                elif option == config.spanish_aep_multi_options_ids_6[2]:
                                    single_select_options_124.append(config.aep_single_select_option_id_34)
                                elif option == config.spanish_aep_multi_options_ids_6[3]:
                                    single_select_options_125.append(config.aep_single_select_option_id_35)

                        elif field_id == config.spanish_aep_multi_select_id_7:
                            multi_select_options_51 = data.getOptions()
                            for option in multi_select_options_51:
                                if option == config.spanish_aep_multi_options_ids_7[0]:
                                    single_select_options_126.append(config.aep_single_select_option_id_36)
                                elif option == config.spanish_aep_multi_options_ids_7[1]:
                                    single_select_options_127.append(config.aep_single_select_option_id_37)
                                elif option == config.spanish_aep_multi_options_ids_7[2]:
                                    single_select_options_128.append(config.aep_single_select_option_id_38)
                                elif option == config.spanish_aep_multi_options_ids_7[3]:
                                    single_select_options_129.append(config.aep_single_select_option_id_39)
                                elif option == config.spanish_aep_multi_options_ids_7[4]:
                                    single_select_options_130.append(config.aep_single_select_option_id_40)
                                elif option == config.spanish_aep_multi_options_ids_7[5]:
                                    single_select_options_131.append(config.aep_single_select_option_id_41)
                                elif option == config.spanish_aep_multi_options_ids_7[6]:
                                    single_select_options_132.append(config.aep_single_select_option_id_42)
                                elif option == config.spanish_aep_multi_options_ids_7[7]:
                                    single_select_options_133.append(config.aep_single_select_option_id_43)

                        elif field_id == config.spanish_aep_multi_select_id_8:
                            multi_select_options_52 = data.getOptions()
                            for option in multi_select_options_52:
                                if option == config.spanish_aep_multi_options_ids_8[0]:
                                    single_select_options_134.append(config.aep_single_select_option_id_44)
                                elif option == config.spanish_aep_multi_options_ids_8[1]:
                                    single_select_options_135.append(config.aep_single_select_option_id_45)
                                elif option == config.spanish_aep_multi_options_ids_8[2]:
                                    single_select_options_136.append(config.aep_single_select_option_id_46)
                                elif option == config.spanish_aep_multi_options_ids_8[3]:
                                    single_select_options_137.append(config.aep_single_select_option_id_47)

                        elif field_id == config.spanish_aep_multi_select_id_9:
                            multi_select_options_53 = data.getOptions()
                            for option in multi_select_options_53:
                                if option == config.spanish_aep_multi_options_ids_9[0]:
                                    single_select_options_138.append(config.aep_single_select_option_id_48)
                                elif option == config.spanish_aep_multi_options_ids_9[1]:
                                    single_select_options_139.append(config.aep_single_select_option_id_49)
                                elif option == config.spanish_aep_multi_options_ids_9[2]:
                                    single_select_options_140.append(config.aep_single_select_option_id_50)
                                elif option == config.spanish_aep_multi_options_ids_9[3]:
                                    single_select_options_141.append(config.aep_single_select_option_id_51)

                        # Spanish - GI multi-select
                        elif field_id == config.spanish_gi_multi_select_id_1:
                            multi_select_options_54 = data.getOptions()
                            for option in multi_select_options_54:
                                if option == config.spanish_gi_multi_options_ids_1[0]:
                                    single_select_options_142.append(config.gi_single_select_option_id_1)
                                elif option == config.spanish_gi_multi_options_ids_1[1]:
                                    single_select_options_143.append(config.gi_single_select_option_id_2)
                                elif option == config.spanish_gi_multi_options_ids_1[2]:
                                    single_select_options_144.append(config.gi_single_select_option_id_3)
                                elif option == config.spanish_gi_multi_options_ids_1[3]:
                                    single_select_options_145.append(config.gi_single_select_option_id_4)
                                elif option == config.spanish_gi_multi_options_ids_1[4]:
                                    single_select_options_146.append(config.gi_single_select_option_id_5)
                                elif option == config.spanish_gi_multi_options_ids_1[5]:
                                    single_select_options_147.append(config.gi_single_select_option_id_6)
                                elif option == config.spanish_gi_multi_options_ids_1[6]:
                                    single_select_options_148.append(config.gi_single_select_option_id_7)
                                elif option == config.spanish_gi_multi_options_ids_1[7]:
                                    single_select_options_149.append(config.gi_single_select_option_id_8)
                                elif option == config.spanish_gi_multi_options_ids_1[8]:
                                    single_select_options_150.append(config.gi_single_select_option_id_9)

                        elif field_id == config.spanish_gi_multi_select_id_2:
                            multi_select_options_55 = data.getOptions()
                            for option in multi_select_options_55:
                                if option == config.spanish_gi_multi_options_ids_2[0]:
                                    single_select_options_151.append(config.gi_single_select_option_id_10)
                                elif option == config.spanish_gi_multi_options_ids_2[1]:
                                    single_select_options_152.append(config.gi_single_select_option_id_11)
                                elif option == config.spanish_gi_multi_options_ids_2[2]:
                                    single_select_options_153.append(config.gi_single_select_option_id_12)
                                elif option == config.spanish_gi_multi_options_ids_2[3]:
                                    single_select_options_154.append(config.gi_single_select_option_id_13)
                                elif option == config.spanish_gi_multi_options_ids_2[4]:
                                    single_select_options_155.append(config.gi_single_select_option_id_14)
                                elif option == config.spanish_gi_multi_options_ids_2[5]:
                                    single_select_options_156.append(config.gi_single_select_option_id_15)

                        elif field_id == config.spanish_gi_multi_select_id_3:
                            multi_select_options_56 = data.getOptions()
                            for option in multi_select_options_56:
                                if option == config.spanish_gi_multi_options_ids_3[0]:
                                    single_select_options_157.append(config.gi_single_select_option_id_16)
                                elif option == config.spanish_gi_multi_options_ids_3[1]:
                                    single_select_options_158.append(config.gi_single_select_option_id_17)
                                elif option == config.spanish_gi_multi_options_ids_3[2]:
                                    single_select_options_159.append(config.gi_single_select_option_id_18)
                                elif option == config.spanish_gi_multi_options_ids_3[3]:
                                    single_select_options_160.append(config.gi_single_select_option_id_19)
                                elif option == config.spanish_gi_multi_options_ids_3[4]:
                                    single_select_options_161.append(config.gi_single_select_option_id_20)

                        elif field_id == config.spanish_gi_multi_select_id_4:
                            multi_select_options_57 = data.getOptions()
                            for option in multi_select_options_57:
                                if option == config.spanish_gi_multi_options_ids_4[0]:
                                    single_select_options_162.append(config.gi_single_select_option_id_21)
                                elif option == config.spanish_gi_multi_options_ids_4[1]:
                                    single_select_options_163.append(config.gi_single_select_option_id_22)
                                elif option == config.spanish_gi_multi_options_ids_4[2]:
                                    single_select_options_164.append(config.gi_single_select_option_id_23)
                                elif option == config.spanish_gi_multi_options_ids_4[3]:
                                    single_select_options_165.append(config.gi_single_select_option_id_24)
                                elif option == config.spanish_gi_multi_options_ids_4[4]:
                                    single_select_options_166.append(config.gi_single_select_option_id_25)

                        elif field_id == config.spanish_gi_multi_select_id_5:
                            multi_select_options_58 = data.getOptions()
                            for option in multi_select_options_58:
                                if option == config.spanish_gi_multi_options_ids_5[0]:
                                    single_select_options_167.append(config.gi_single_select_option_id_26)
                                elif option == config.spanish_gi_multi_options_ids_5[1]:
                                    single_select_options_168.append(config.gi_single_select_option_id_27)
                                elif option == config.spanish_gi_multi_options_ids_5[2]:
                                    single_select_options_169.append(config.gi_single_select_option_id_28)
                                elif option == config.spanish_gi_multi_options_ids_5[3]:
                                    single_select_options_170.append(config.gi_single_select_option_id_29)
                                elif option == config.spanish_gi_multi_options_ids_5[4]:
                                    single_select_options_171.append(config.gi_single_select_option_id_30)
                                elif option == config.spanish_gi_multi_options_ids_5[5]:
                                    single_select_options_172.append(config.gi_single_select_option_id_31)

                        elif field_id == config.spanish_gi_multi_select_id_6:
                            multi_select_options_59 = data.getOptions()
                            for option in multi_select_options_59:
                                if option == config.spanish_gi_multi_options_ids_6[0]:
                                    single_select_options_173.append(config.gi_single_select_option_id_32)
                                elif option == config.spanish_gi_multi_options_ids_6[1]:
                                    single_select_options_174.append(config.gi_single_select_option_id_33)
                                elif option == config.spanish_gi_multi_options_ids_6[2]:
                                    single_select_options_175.append(config.gi_single_select_option_id_34)
                                elif option == config.spanish_gi_multi_options_ids_6[3]:
                                    single_select_options_176.append(config.gi_single_select_option_id_35)
                                elif option == config.spanish_gi_multi_options_ids_6[4]:
                                    single_select_options_177.append(config.gi_single_select_option_id_36)
                                elif option == config.spanish_gi_multi_options_ids_6[5]:
                                    single_select_options_178.append(config.gi_single_select_option_id_37)
                                elif option == config.spanish_gi_multi_options_ids_6[6]:
                                    single_select_options_179.append(config.gi_single_select_option_id_38)
                                elif option == config.spanish_gi_multi_options_ids_6[7]:
                                    single_select_options_180.append(config.gi_single_select_option_id_39)
                                elif option == config.spanish_gi_multi_options_ids_6[8]:
                                    single_select_options_181.append(config.gi_single_select_option_id_40)
                                elif option == config.spanish_gi_multi_options_ids_6[9]:
                                    single_select_options_182.append(config.gi_single_select_option_id_41)
                                elif option == config.spanish_gi_multi_options_ids_6[10]:
                                    single_select_options_183.append(config.gi_single_select_option_id_42)
                                elif option == config.spanish_gi_multi_options_ids_6[11]:
                                    single_select_options_184.append(config.gi_single_select_option_id_43)
                                elif option == config.spanish_gi_multi_options_ids_6[12]:
                                    single_select_options_185.append(config.gi_single_select_option_id_44)
                                elif option == config.spanish_gi_multi_options_ids_6[13]:
                                    single_select_options_186.append(config.gi_single_select_option_id_45)

                        # Spanish - App survey multi-select
                        elif field_id == config.spanish_app_survey_multi_select_id_1:
                            multi_select_options_60 = data.getOptions()
                            for option in multi_select_options_60:
                                if option == config.spanish_app_survey_multi_options_ids_1[0]:
                                    single_select_options_187.append(config.app_single_select_option_id_1)
                                elif option == config.spanish_app_survey_multi_options_ids_1[1]:
                                    single_select_options_188.append(config.app_single_select_option_id_2)
                                elif option == config.spanish_app_survey_multi_options_ids_1[2]:
                                    single_select_options_189.append(config.app_single_select_option_id_3)
                                elif option == config.spanish_app_survey_multi_options_ids_1[3]:
                                    single_select_options_190.append(config.app_single_select_option_id_4)
                                elif option == config.spanish_app_survey_multi_options_ids_1[4]:
                                    single_select_options_191.append(config.app_single_select_option_id_5)
                                elif option == config.spanish_app_survey_multi_options_ids_1[5]:
                                    single_select_options_192.append(config.app_single_select_option_id_6)
                                elif option == config.spanish_app_survey_multi_options_ids_1[6]:
                                    single_select_options_193.append(config.app_single_select_option_id_7)

                        elif field_id == config.spanish_app_survey_multi_select_id_2:
                            multi_select_options_61 = data.getOptions()
                            for option in multi_select_options_61:
                                if option == config.spanish_app_survey_multi_options_ids_2[0]:
                                    single_select_options_194.append(config.app_single_select_option_id_8)
                                elif option == config.spanish_app_survey_multi_options_ids_2[1]:
                                    single_select_options_195.append(config.app_single_select_option_id_9)
                                elif option == config.spanish_app_survey_multi_options_ids_2[2]:
                                    single_select_options_196.append(config.app_single_select_option_id_10)
                                elif option == config.spanish_app_survey_multi_options_ids_2[3]:
                                    single_select_options_197.append(config.app_single_select_option_id_11)
                                elif option == config.spanish_app_survey_multi_options_ids_2[4]:
                                    single_select_options_198.append(config.app_single_select_option_id_12)

                        elif field_id == config.spanish_app_survey_multi_select_id_3:
                            multi_select_options_62 = data.getOptions()
                            for option in multi_select_options_62:
                                if option == config.spanish_app_survey_multi_options_ids_3[0]:
                                    single_select_options_199.append(config.app_single_select_option_id_13)
                                elif option == config.spanish_app_survey_multi_options_ids_3[1]:
                                    single_select_options_200.append(config.app_single_select_option_id_14)
                                elif option == config.spanish_app_survey_multi_options_ids_3[2]:
                                    single_select_options_201.append(config.app_single_select_option_id_15)
                                elif option == config.spanish_app_survey_multi_options_ids_3[3]:
                                    single_select_options_202.append(config.app_single_select_option_id_16)
                                elif option == config.spanish_app_survey_multi_options_ids_3[4]:
                                    single_select_options_203.append(config.app_single_select_option_id_17)
                                elif option == config.spanish_app_survey_multi_options_ids_3[5]:
                                    single_select_options_204.append(config.app_single_select_option_id_18)
                                elif option == config.spanish_app_survey_multi_options_ids_3[6]:
                                    single_select_options_205.append(config.app_single_select_option_id_19)
                                elif option == config.spanish_app_survey_multi_options_ids_3[7]:
                                    single_select_options_206.append(config.app_single_select_option_id_20)
                                elif option == config.spanish_app_survey_multi_options_ids_3[8]:
                                    single_select_options_207.append(config.app_single_select_option_id_21)
                                elif option == config.spanish_app_survey_multi_options_ids_3[9]:
                                    single_select_options_208.append(config.app_single_select_option_id_22)

                        elif field_id == config.spanish_app_survey_multi_select_id_4:
                            multi_select_options_63 = data.getOptions()
                            for option in multi_select_options_63:
                                if option == config.spanish_app_survey_multi_options_ids_4[0]:
                                    single_select_options_209.append(config.app_single_select_option_id_23)
                                elif option == config.spanish_app_survey_multi_options_ids_4[1]:
                                    single_select_options_210.append(config.app_single_select_option_id_24)
                                elif option == config.spanish_app_survey_multi_options_ids_4[2]:
                                    single_select_options_211.append(config.app_single_select_option_id_25)
                                elif option == config.spanish_app_survey_multi_options_ids_4[3]:
                                    single_select_options_212.append(config.app_single_select_option_id_26)
                                elif option == config.spanish_app_survey_multi_options_ids_4[4]:
                                    single_select_options_213.append(config.app_single_select_option_id_27)
                                elif option == config.spanish_app_survey_multi_options_ids_4[5]:
                                    single_select_options_214.append(config.app_single_select_option_id_28)

                        elif field_id == config.spanish_app_survey_multi_select_id_5:
                            multi_select_options_64 = data.getOptions()
                            for option in multi_select_options_64:
                                if option == config.spanish_app_survey_multi_options_ids_3[0]:
                                    single_select_options_215.append(config.app_single_select_option_id_29)
                                elif option == config.spanish_app_survey_multi_options_ids_3[1]:
                                    single_select_options_216.append(config.app_single_select_option_id_30)
                        ...
                        elif field_id == config.spanish_app_survey_multi_select_id_6:
                            multi_select_options_65 = data.getOptions()
                            for option in multi_select_options_65:
                                if option == config.spanish_app_survey_multi_options_ids_6[0]:
                                    single_select_options_224.append(config.app_single_select_option_id_38)
                                elif option == config.spanish_app_survey_multi_options_ids_6[1]:
                                    single_select_options_225.append(config.app_single_select_option_id_39)
                                elif option == config.spanish_app_survey_multi_options_ids_6[2]:
                                    single_select_options_226.append(config.app_single_select_option_id_40)
                                elif option == config.spanish_app_survey_multi_options_ids_6[3]:
                                    single_select_options_227.append(config.app_single_select_option_id_41)
                                elif option == config.spanish_app_survey_multi_options_ids_6[4]:
                                    single_select_options_228.append(config.app_single_select_option_id_42)
                                elif option == config.spanish_app_survey_multi_options_ids_6[5]:
                                    single_select_options_229.append(config.app_single_select_option_id_43)
                                elif option == config.spanish_app_survey_multi_options_ids_6[6]:
                                    single_select_options_230.append(config.app_single_select_option_id_44)
                                elif option == config.spanish_app_survey_multi_options_ids_6[7]:
                                    single_select_options_231.append(config.app_single_select_option_id_45)
                                elif option == config.spanish_app_survey_multi_options_ids_6[8]:
                                    single_select_options_232.append(config.app_single_select_option_id_46)
                                elif option == config.spanish_app_survey_multi_options_ids_6[9]:
                                    single_select_options_233.append(config.app_single_select_option_id_47)
                                elif option == config.spanish_app_survey_multi_options_ids_6[10]:
                                    single_select_options_234.append(config.app_single_select_option_id_48)
                                elif option == config.spanish_app_survey_multi_options_ids_6[11]:
                                    single_select_options_235.append(config.app_single_select_option_id_49)
                                elif option == config.spanish_app_survey_multi_options_ids_6[12]:
                                    single_select_options_236.append(config.app_single_select_option_id_50)
                                elif option == config.spanish_app_survey_multi_options_ids_6[13]:
                                    single_select_options_237.append(config.app_single_select_option_id_51)

                        elif field_id == config.spanish_app_survey_multi_select_id_7:
                            multi_select_options_66 = data.getOptions()
                            for option in multi_select_options_66:
                                if option == config.spanish_app_survey_multi_options_ids_7[0]:
                                    single_select_options_238.append(config.app_single_select_option_id_52)
                                elif option == config.spanish_app_survey_multi_options_ids_7[1]:
                                    single_select_options_239.append(config.app_single_select_option_id_53)
                                elif option == config.spanish_app_survey_multi_options_ids_7[2]:
                                    single_select_options_240.append(config.app_single_select_option_id_54)
                                elif option == config.spanish_app_survey_multi_options_ids_7[3]:
                                    single_select_options_241.append(config.app_single_select_option_id_55)
                                elif option == config.spanish_app_survey_multi_options_ids_7[4]:
                                    single_select_options_242.append(config.app_single_select_option_id_56)
                                elif option == config.spanish_app_survey_multi_options_ids_7[5]:
                                    single_select_options_243.append(config.app_single_select_option_id_57)
                                elif option == config.spanish_app_survey_multi_options_ids_7[6]:
                                    single_select_options_244.append(config.app_single_select_option_id_58)
                                elif option == config.spanish_app_survey_multi_options_ids_7[7]:
                                    single_select_options_245.append(config.app_single_select_option_id_59)
                                elif option == config.spanish_app_survey_multi_options_ids_7[8]:
                                    single_select_options_246.append(config.app_single_select_option_id_60)
                                elif option == config.spanish_app_survey_multi_options_ids_7[9]:
                                    single_select_options_247.append(config.app_single_select_option_id_61)
                                elif option == config.spanish_app_survey_multi_options_ids_7[10]:
                                    single_select_options_248.append(config.app_single_select_option_id_62)
                                elif option == config.spanish_app_survey_multi_options_ids_7[11]:
                                    single_select_options_249.append(config.app_single_select_option_id_63)
                                elif option == config.app_survey_multi_options_ids_7[12]:
                                    single_select_options_250.append(config.app_single_select_option_id_64)
                    ...
                    try:
                        # create internal form for UID and multi-select mapping
                    ...
                    try:
                        ...
                        # log the failure
                        logger.info(f"project 1 - failed to check unique id for submission: {primary_unique_id} for submission: {submission_id}")
                        break

            # check project 2
            elif project_id == self.project_id_2 or project_id == self.project_id_4:
                if project_id == self.project_id_2:
                    logger.info(f"project 2 - Submission {submission_id}")
                elif project_id == self.project_id_4:
                    logger.info(f"project 4 - Submission {submission_id}")
                ...
                for response in response_list:
                    ...
                    for data in field_data:
                        ...
                        # English GI (project-1) Primary Artist UID | DOB-LastName-Zipcode
                        ...
                        # Spanish GI (project-4) Primary Artist UID | DOB-LastName-Zipcode
                    ...
                    try:
                        if primary_last_name is not None and primary_dob is not None and primary_zip is not None:
                            ...
                            logger.info(f"project 2 - save to dict {primary_unique_id} sub id {submission_id}")
                            config.uid_data_struct.append({'submission_id': submission_id, 'primary_unique_id':  primary_unique_id,
                        ...
                        # log the failure
                        logger.info(f"project 2 - failed to check unique id for submission: {primary_unique_id} for submission: {submission_id}")
                        # go to next submission
                        break
